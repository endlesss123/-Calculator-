package com.github.endlesss123.calculator_wn25;
...
class CalculatorTest {
    ...
    void testSubtract() {
        assertEquals(2, calculator.subtract(4, 2),"Subtract 2 from 4");
    }
    ...
    void testMultiplication() {
        assertEquals(4, calculator.multiply(2, 2), "Multiply 2 and 2");
    }
